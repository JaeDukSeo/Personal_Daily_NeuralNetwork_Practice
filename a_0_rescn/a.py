...
# Make the Netwokr
l1 = ResCNNLayer(13,1,5,tf_tanh,d_tf_tanh)
l2 = ResCNNLayer(7,5,7,tf_log,d_tf_log)
l3 = ResCNNLayer(3,7,9,tf_tanh,d_tf_tanh)

l4 = ResCNNLayer(5,9,9,tf_tanh,d_tf_tanh)
l5 = ResCNNLayer(3,9,3,tf_log,d_tf_log)
