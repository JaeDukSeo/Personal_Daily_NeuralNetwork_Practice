...
G_input = 600
hidden_input,hidden_input2 = 660,780
...
G_W3 = np.random.normal(size=(hidden_input2,784),scale=(1. / np.sqrt(hidden_input / 2.)))  *0.002
...
for iter in range(num_epoch):
    ...
    # Func: Gradient
    grad_G_w3_part_1 = ((-1/Dl2_A) * d_log(Dl2).dot(D_W2.T) * (d_ReLu(Dl1))).dot(D_W1.T)
    grad_G_w3_part_2 = d_log(Gl3)
    ...
    if iter%200 == 0:
        ...
        plt.savefig('multi4/{}.png'.format(str(iter).zfill(3)+"_Ginput_"+str(G_input)+ \
