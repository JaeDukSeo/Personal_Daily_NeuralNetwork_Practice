...
# 2. Declare Hyper Parameters tf.random_normal(shape=size, stddev=(1. / tf.sqrt(size[0] / 2.)))

D_w1 = np.random.normal(size=(784,256), scale=(1. / np.sqrt(784 / 2.))) 
D_w2 = np.random.normal(size=(256,128), scale=(1. / np.sqrt(246 / 2.))) 
D_w3 = np.random.normal(size=(128,1), scale=(1. / np.sqrt(128 / 2.))) 

G_w1 = np.random.normal(size=(100,280), scale=(1. / np.sqrt(100 / 2.))) 
G_w2 = np.random.normal(size=(280,380), scale=(1. / np.sqrt(280 / 2.))) 
G_w3 = np.random.normal(size=(380,560), scale=(1. / np.sqrt(380 / 2.))) 
G_w4 = np.random.normal(size=(560,784), scale=(1. / np.sqrt(560 / 2.))) 
