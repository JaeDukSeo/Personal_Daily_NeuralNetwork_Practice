...
grad5_s,grad5_sw = l5_s.backprop(error_soft)
grad5_2,grad5_2w = l5_2.backprop(error_soft)
grad5_1,grad5_1w = l5_1.backprop(grad5_2)

grad4_s,grad4_sw = l4_s.backprop(grad5_1+grad5_s)
grad4_2,grad4_2w = l4_2.backprop(grad5_1+grad5_s)
grad4_1,grad4_1w = l4_1.backprop(grad4_2)

grad3_s,grad3_sw = l3_s.backprop(grad4_1+grad4_s)
