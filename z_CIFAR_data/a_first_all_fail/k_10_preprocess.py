...
# save data
train.use_design_loc('./cifar10_preprocessed/train.npy')
serial.save('./cifar10_preprocessed/train.pkl', train)
...
# save data
test.use_design_loc('./cifar10_preprocessed/test.npy')
serial.save('./cifar10_preprocessed/test.pkl', test)
