...
test_mask_location = "./final_test_mask/"
test_original_loc  = "./b_data/test2/"
test_excel_location = "./b_data/stage2_sample_submission_final.csv"

# get all of the files
test_mask_files = []  # create an empty list
for dirName, subdirList, fileList in os.walk(test_mask_location):
    for filename in fileList:
        if ".png" in filename.lower():  # check whether the file's DICOM
            test_mask_files.append(os.path.join(dirName,filename))
