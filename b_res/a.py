...
test_image_num,training_image_num = 50,550
...
# 2. Hyper Parameters
w1a = np.random.randn(784,824)
w1b = np.random.randn(824,761)
w1h = np.random.randn(784,761)

w2a = np.random.randn(761,512)
w2b = np.random.randn(512,256)
w2h = np.random.randn(761,256)

w3a = np.random.randn(256,128)
w3b = np.random.randn(128,10)*0.02
w3h = np.random.randn(256,10) *0.03
