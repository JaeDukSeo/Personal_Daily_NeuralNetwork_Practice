...
layer9  = FCNN(28*28,824)
layer10  =FCNN(824,1024)
layer11 = FCNN(1024,10)
...
l4 = layer4.feedforward(l3,4)

l5 = layer5.feedforward(l4,8)
l6 = layer6.feedforward(l5,16)
l7 = layer7.feedforward(l6,1)
...
with tf.Session() as sess:
    ...
    plt.figure()
    plt.plot(range(len(avg_acc_overtime)),avg_acc_overtime )
    plt.title("Accuracy over time Training Images")
    plt.show()
    plt.figure()
    plt.plot(range(len(avg_cost_overtime)),avg_cost_overtime )
    plt.title("Cost over time Training Images")
    plt.show()
    plt.figure()
    plt.plot(range(len(avg_acc_overtime_text)),avg_acc_overtime_text )
    plt.title("Accuracy over time Testing Images")
    plt.show()
    plt.figure()
    plt.plot(range(len(avg_cost_overtime_text)),avg_cost_overtime_text )
    plt.title("Cost over time Testing Images")
    plt.show()
# -- end code --